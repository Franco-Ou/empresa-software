...
public class testEmpresa {
	...
	public void liquidarSueldos() {
		...
		/*
		 * El empleado uno tiene 2 ausencias y 4 llegas tarde, lo que da un total de 3
		 * ausencias. Se le deberá descontar de su suedo 3 dias de trabajo.
		 * 50000-7500=42500
		 */
		...
		/*
		 * El empleado dos tiene 2 ausencias. Está dentro de la tolerancia, no se le
		 * debe descontar.
		 */
		...
		/*
		 * El empleado 3 tiene 7 llegadas tarde. Eso contabiliza 3 ausencias. Se le debe
		 * descontar 12000
		 */
		for (int i = 0; i < 7; i++) {
	...
	public void queCalculeCorrectamenteLaIndemnizacion() {
		...
		Empleado Jose = new Empleado(37090520, 8526, "Jos�", 25000.00, 2011);
